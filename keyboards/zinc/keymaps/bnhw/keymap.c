...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Esc  |      | Win  | Alt  |ADJUST|Space |             | RAISE| LOWER| Left | Down |  Up  | Right|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_ESC, _______,  KC_LGUI, KC_LALT, ADJUST,  KC_SPC,                    RAISE,   LOWER,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, KC_UNDS, KC_MINS, KC_PLUS, KC_EQL,  KC_BSLS,                   KC_PIPE, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______, \
