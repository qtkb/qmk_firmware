...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Esc  | Win  | Alt  |ADJUST|LOWER |Space |             | Enter| RAISE| Left | Down |  Up  | Right|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT_ortho_4x12(
      ...
      KC_ESC,  KC_LGUI, KC_LALT, ADJUST,  LOWER,   KC_SPC,                    KC_ENT,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_UNDS, KC_PLUS, _______, KC_LCBR, KC_RCBR, KC_PIPE, \
  ...
  [_RAISE] = LAYOUT_ortho_4x12( \
      ...
      _______, _______, _______, _______, _______, _______,                   KC_MINS, KC_EQL,  _______, KC_LBRC, KC_RBRC, KC_BSLS, \
      _______, _______, _______, _______, _______, _______,                   _______, KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END \
      ),
