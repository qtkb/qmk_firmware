...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_splits(
    ...
    LS_CAPS,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                      KC_LGUI, KC_LALT, KC_LCTL,          KC_SPC,  SYM_ENT,          FUNCS,   CONFIG
      ),
  [_SYMBOLS] = LAYOUT_splits(
    ...
    _______,          KC_UNDS, KC_PMNS, KC_PPLS, KC_EQL,  KC_PIPE, KC_BSLS, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, _______,
  ...
  [_FUNCTIONS] = LAYOUT_splits(
    ...
    _______,          KC_F5,   KC_F6,   KC_F7,   KC_F8,   XXXXXXX, XXXXXXX, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_MPLY,
  ...
  [_CONFIG] = LAYOUT_splits(
    ...
    _______,          RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX, CG_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, _______,
                      _______, _______, _______,          _______, _______,          _______, _______
  ),
};

void show_config_state_lights(bool swap_lctl_lgui)
{
    // Show left light if ctrl and gui swapped
    if (swap_lctl_lgui)
    {
        PORTD |= (1 << PD0);
    }
...
layer_state_t layer_state_set_user(layer_state_t state)
{
    ...
    if (state & (1 << _CONFIG))
    {
        show_config_state_lights(keymap_config.swap_lctl_lgui);
    }
